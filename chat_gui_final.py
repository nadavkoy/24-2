...
class ChatPanel(wx.Panel):
    ...
    def receive_songs(self):
        ...
        while True:
            ...
            if self.parent_frame.stop_threads is True:
                ...
                song_file = song[1].split(END_OF_SONG)[0]  # extracting mp3 file
                ...
                if self.parent_frame.started_playing:
                    ...
                    t3 = threading.Thread(target=self.play_song, args=())
                    t3.start()
    ...
    def play_song(self):
        ...
        self.h_box.Add(self.volume_up, 0, wx.ALIGN_CENTER_HORIZONTAL)
        self.h_box.Add(self.volume_down, 0, wx.ALIGN_CENTER_HORIZONTAL)

        self.v_box.Add(self.h_box, 0, wx.ALIGN_CENTER_HORIZONTAL)
        ...
        while True:
            while SONGS_TO_PLAY:
                ...
                songLength = song2.info.length
                print songLength

                self.mixer.play(start=10.0)
